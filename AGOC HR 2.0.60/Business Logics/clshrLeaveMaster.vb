...
#Region "FormatGrid"
    Private Sub Formatgrid(ByVal agrid As SAPbouiCOM.Grid)
        ...
        agrid.Columns.Item("U_Z_Sort").TitleObject.Caption = "Sorting of Leave Types"

        agrid.Columns.Item("U_Z_HideESS").Type = SAPbouiCOM.BoGridColumnType.gct_CheckBox
        agrid.Columns.Item("U_Z_HideESS").TitleObject.Caption = "Hide from ESS"
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If oGrid.DataTable.GetValue(0, intRow) <> "" Or oGrid.DataTable.GetValue(1, intRow) <> "" Then
                ...
                If oUserTable.GetByKey(strCode) = False Then
                    ...
                    End If
                    OCHECKBOXCOLUMN = oGrid.Columns.Item("U_Z_HideESS")
                    Try
                        If OCHECKBOXCOLUMN.IsChecked(intRow) Then
                            oUserTable.UserFields.Fields.Item("U_Z_HideESS").Value = "Y"
                        Else
                            oUserTable.UserFields.Fields.Item("U_Z_HideESS").Value = "N"
                        End If
                    Catch ex As Exception
                        oUserTable.UserFields.Fields.Item("U_Z_HideESS").Value = "N"
                    End Try
                    ...
                    oUserTable.UserFields.Fields.Item("U_Z_Sort").Value = (oGrid.DataTable.GetValue("U_Z_Sort", intRow))
