    ...
    Private Function Validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Try
            ...
            If oApplication.Utilities.getEdittextvalue(aForm, "12") = "" Then
                ...
                Return False
            End If
            If oApplication.Utilities.getEdittextvalue(aForm, "51") = "" Then
                oApplication.Utilities.Message("Enter Grade from...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                oForm.Items.Item("51").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                Return False
            End If
            If oApplication.Utilities.getEdittextvalue(aForm, "53") = "" Then
                oApplication.Utilities.Message("Enter Grade To...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                oForm.Items.Item("53").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                Return False
            End If
                                    ...
                                    If (oCFLEvento.BeforeAction = False) Then
                                        ...
                                        If pVal.ItemUID = "24" Then
                                            Try
                                                ...
                                                oApplication.Utilities.setEdittextvalue(oForm, "24", val)
                                            Catch ex As Exception
                                            End Try
                                            If oForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                                                oForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE
                                        ...
                                        If pVal.ItemUID = "53" Then
                                            Try
                                                val = oDataTable.GetValue("U_Z_GrdeCode", 0)
                                                oApplication.Utilities.setEdittextvalue(oForm, "53", val)
                                            Catch ex As Exception
                                            End Try
                                            If oForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                                                oForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE
