...
Public Class clshrTraExpOverView
    ...
    Private Sub Databind(ByVal aform As SAPbouiCOM.Form, ByVal strTitle As String)
        ...
        If strTitle = "Travel OverView" Then
            ...
            strqry = "Select DocEntry,U_Z_DocDate, U_Z_EmpId,U_Z_EmpName,case isnull(U_Z_NewReq,'N') when 'Y' then 'New Travel Request' else U_Z_TraCode end U_Z_TraCode,U_Z_TraName, U_Z_TraStDate 'Trip StartDate',U_Z_TraEndDate 'Trip EndDate',U_Z_ReqAppDate,U_Z_ReqClaimDate,"
            ...
            strqry = strqry & "  when 'CA' then 'Claim Approved' when 'CJ' then 'Claim Rejected' else 'Closed' end as U_Z_Status, Case U_Z_AppStatus when 'P' then 'Pending' when 'R' then 'Rejected' when 'A' then 'Approved' else 'Pending' end as 'Approval Status' from [@Z_HR_OTRAREQ] where (U_Z_Status<>'CR' and U_Z_Status<>'CA' and U_Z_Status<>'CJ') and " & strcondition
        Else
            Dim strcondition As String
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_MATRIX_LINK_PRESSED
                                ...
                                If pVal.ItemUID = "10" And pVal.ColUID = "U_Z_TraCode" Then
                                    ...
                                    If oGrid.DataTable.GetValue(pVal.ColUID, pVal.Row) = "New Travel Request" Then
                                        BubbleEvent = False
                                        Exit Sub
                                    End If
