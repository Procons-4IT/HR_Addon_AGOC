Public Class clshrHireToEmp
    ...
    Private Sub BindData(ByVal aform As SAPbouiCOM.Form)
        ...
        strqry = " select U_Z_ReqNo,U_Z_JobPosi,T0.DocEntry, U_Z_HRAppID,U_Z_HRAppName,T0.U_Z_Dept,T0.U_Z_DeptName,U_Z_JobPosiCode,T0.U_Z_Dob,U_Z_Email,T0.U_Z_Mobile,T0.U_Z_YrExp,T0.U_Z_Skills,"
        ...
        oGrid.Columns.Item("U_Z_JobPosiCode").TitleObject.Caption = "Position "
