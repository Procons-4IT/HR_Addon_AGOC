    ...
    Private Function validation(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        If EntryChoice = "TraReq" Then
            ...
            If otemp.RecordCount <= 0 Then
                ...
                Return False
            Else
                ExpintTempID = oApplication.Utilities.CheckApprovalExists(HeaderDoctype.TraReq, otemp.Fields.Item(0).Value)
        ...
        If EntryChoice = "EmpExpClaim" Then
            ...
            If otemp.RecordCount <= 0 Then
                ...
                Return False
            ElseIf ActionType = "V" Then
                ExpintTempID = oApplication.Utilities.CheckApprovalExists(HeaderDoctype.ExpCli, otemp.Fields.Item(0).Value)
                If ExpintTempID = "0" Then
                    oApplication.Utilities.Message("Approval template is not defined . You can't create request. please Contact the Administrator...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                    Return False
                End If
        ...
        If EntryChoice = "LVEREQ" Then
            ...
            If otemp.RecordCount <= 0 Then
                ...
                Return False
            ElseIf ActionType = "V" Then
                ExpintTempID = oApplication.Utilities.CheckApprovalExists(HeaderDoctype.LveReq, otemp.Fields.Item(0).Value)
                If ExpintTempID = "0" Then
                    oApplication.Utilities.Message("Approval template is not defined . You can't create request. please Contact the Administrator...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                    Return False
                End If
