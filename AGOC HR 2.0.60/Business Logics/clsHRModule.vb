...
#Region "AddControls"
    Private Function AddControls(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Try
            ...
            oApplication.Utilities.AddControls(aForm, "stHiDt", "HRstCNa", SAPbouiCOM.BoFormItemTypes.it_STATIC, "DOWN", 23, 23, , "Hijri Date of Birth", , )
            oApplication.Utilities.AddControls(aForm, "edHiDt", "HRedCNa", SAPbouiCOM.BoFormItemTypes.it_EDIT, "DOWN", 23, 23, , , , )
            oEditText = aForm.Items.Item("edHiDt").Specific
            oEditText.DataBind.SetBound(True, "OHEM", "U_Z_HirijiDob")
            aForm.Items.Item("edHiDt").Enabled = False
            oItem = aForm.Items.Item("stHiDt")
            oItem.LinkTo = "edHiDt"

            oApplication.Utilities.AddControls(aForm, "stRetdt", "stHiDt", SAPbouiCOM.BoFormItemTypes.it_STATIC, "DOWN", 23, 23, , "Retirement Hijri Date", , )
            oApplication.Utilities.AddControls(aForm, "edRetdt", "edHiDt", SAPbouiCOM.BoFormItemTypes.it_EDIT, "DOWN", 23, 23, , , , )
            oEditText = aForm.Items.Item("edRetdt").Specific
            oEditText.DataBind.SetBound(True, "OHEM", "U_Z_RetDate")
            aForm.Items.Item("edRetdt").Enabled = False
            oItem = aForm.Items.Item("stRetdt")
            oItem.LinkTo = "edRetdt"
            ...
            'oApplication.Utilities.AddControls(aForm, "stHiDt", "1980002105", SAPbouiCOM.BoFormItemTypes.it_STATIC, "DOWN", 4, 4, , "Hijri Date of Birth", , )
            'oApplication.Utilities.AddControls(aForm, "edHiDt", "1980002107", SAPbouiCOM.BoFormItemTypes.it_EDIT, "DOWN", 4, 4, , , , )
            'oEditText = aForm.Items.Item("edHiDt").Specific
            'oEditText.DataBind.SetBound(True, "OHEM", "U_Z_HirijiDob")
            'aForm.Items.Item("edHiDt").Enabled = False
            'oItem = aForm.Items.Item("stHiDt")
            ...
            'oApplication.Utilities.AddControls(aForm, "stRetdt", "stHiDt", SAPbouiCOM.BoFormItemTypes.it_STATIC, "DOWN", 4, 4, , "Retirement Hijri Date", , )
            'oApplication.Utilities.AddControls(aForm, "edRetdt", "edHiDt", SAPbouiCOM.BoFormItemTypes.it_EDIT, "DOWN", 4, 4, , , , )
            'oEditText = aForm.Items.Item("edRetdt").Specific
            'oEditText.DataBind.SetBound(True, "OHEM", "U_Z_RetDate")
            'aForm.Items.Item("edRetdt").Enabled = False
            'oItem = aForm.Items.Item("stRetdt")
...
#Region "AddToUDT"
    Private Function AddToUDT(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Dim strTable, strEmpId, strCode, strType, strQuery As String
        ...
        oRecSet.DoQuery("Select * from OHEM where position='" & oCombobox.Selected.Value & "' and Active='Y' and empID <>'" & oApplication.Utilities.getEdittextvalue(aForm, "33") & "' ")
        If oRecSet.RecordCount > 0 Then
            oApplication.Utilities.Message("Position already mapped in Employee Number : " & oRecSet.Fields.Item("empID").Value, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Return False
        End If
        strQuery = "Update [@Z_HR_OPOSIN] set U_Z_SalCode='" & oApplication.Utilities.getEdittextvalue(aForm, "HRedSal") & "' where U_Z_PosCode='" & oCombobox.Selected.Description & "'"
...
#End Region
    ...
    Private Function validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        ...
        Try
            oCombobox = aForm.Items.Item("44").Specific
            oRecSet.DoQuery("Select * from OHEM where position='" & oCombobox.Selected.Value & "' and Active='Y' ")
            If oRecSet.RecordCount > 0 Then
                oApplication.Utilities.Message("Position already mapped in Emp.Number" & oRecSet.Fields.Item("empID").Value, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            End If
            Return True
        Catch ex As Exception
                    ...
                    Case True
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.CharPressed <> 9 And (pVal.ItemUID = "edHiDt" Or pVal.ItemUID = "edRetdt" Or pVal.ItemUID = "HRedCNa" Or pVal.ItemUID = "HRedDNa" Or pVal.ItemUID = "HRedUnSt" Or pVal.ItemUID = "HRedScNa" Or pVal.ItemUID = "HRedJobNa1" Or pVal.ItemUID = "HRedLoc" Or pVal.ItemUID = "HRedLcNa" Or pVal.ItemUID = "HRedDiv" Or pVal.ItemUID = "HRedDivNa" Or pVal.ItemUID = "HRedComp" Or pVal.ItemUID = "HRedCoNa" Or pVal.ItemUID = "HRedLcNa" Or pVal.ItemUID = "HRedLvlNa" Or pVal.ItemUID = "HRedgrNa" Or pVal.ItemUID = "HRedJobSt" Or pVal.ItemUID = "HRedposi" Or pVal.ItemUID = "HRedpoNa" Or pVal.ItemUID = "HRedOrgSt" Or pVal.ItemUID = "HRedpoNa" Or pVal.ItemUID = "HRedOrgNa" Or pVal.ItemUID = "HRedJobNa" Or pVal.ItemUID = "HRedAppId") Then
                                    BubbleEvent = False
                                    Exit Sub
                                End If
                    ...
                    Case False
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.ItemUID = "113" And pVal.CharPressed = 9 Then
                                    Dim stdate As Date = oApplication.Utilities.GetDateTimeValue(oApplication.Utilities.getEdittextvalue(oForm, "113"))
                                    ...
                                    oApplication.Utilities.setEdittextvalue(oForm, "edHiDt", Hiriji)

                                    Dim Hiriji1 As String = ConvertDateCalendar(stdate.AddYears(60), "Hijri", "en-")

                                    gdate = stdate.AddYears(60)  'or any other date
                                    hj.DateTimeFormat.Calendar = New HijriCalendar()
                                    hjyr = hj.DateTimeFormat.Calendar.GetYear(gdate)
                                    hjmo = hj.DateTimeFormat.Calendar.GetMonth(gdate)
                                    hjday = hj.DateTimeFormat.Calendar.GetDayOfMonth(gdate)

                                    Hiriji1 = hjyr & hj.DateTimeFormat.GetMonthName(hjmo) & hjday
                                    oApplication.Utilities.setEdittextvalue(oForm, "edRetdt", Hiriji1)
                                End If
