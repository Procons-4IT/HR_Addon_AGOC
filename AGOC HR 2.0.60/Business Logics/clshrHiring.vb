...
#End Region
    ...
    Private Sub BindSalary(ByVal aForm As SAPbouiCOM.Form, ByVal DocEntry As String)
        ...
        End If
    End Sub
    Private Sub RequestReason(ByVal aForm As SAPbouiCOM.Form, ByVal ReqNo As String)
        Dim strqry As String
        oCombobox = aForm.Items.Item("124").Specific
        Dim oTemp As SAPbobsCOM.Recordset
        oTemp = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
        strqry = "select U_Z_RecReason from [@Z_HR_ORMPREQ] where DocEntry='" & ReqNo & "'"
        oTemp.DoQuery(strqry)
        If oTemp.RecordCount > 0 Then
            oCombobox.Select(oTemp.Fields.Item(0).Value, SAPbouiCOM.BoSearchKey.psk_ByValue)
            aForm.Items.Item("84").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
        End If
    End Sub
#Region "Validations"
    Private Function Validation(ByVal aForm As SAPbouiCOM.Form, Optional ByVal aOption As String = "") As Boolean
        Try
            ...
            If oApplication.Utilities.getEdittextvalue(aForm, "89") = "" Then
                ...
                oForm.Items.Item("89").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                Return False
            End If
            If oApplication.Utilities.getEdittextvalue(aForm, "131") = "" Then
                oApplication.Utilities.Message("Current Salary Scale is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                oForm.Items.Item("131").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                Return False
            End If
            If oApplication.Utilities.getEdittextvalue(aForm, "133") = "" Then
                oApplication.Utilities.Message("Salary Scale from is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                oForm.Items.Item("133").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                Return False
            End If
            If oApplication.Utilities.getEdittextvalue(aForm, "135") = "" Then
                oApplication.Utilities.Message("Salary Scale to is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                oForm.Items.Item("135").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                Return False
            End If
            If aOption <> "" Then
                Return True
    ...
    Private Sub LoadFiles(ByVal aform As SAPbouiCOM.Form)
        ...
        For intRow As Integer = 1 To oMatrix.RowCount
            If oMatrix.IsRowSelected(intRow) Then
                ...
                strFilePath = strFilename ' oGrid.DataTable.GetValue("U_Z_Attachment", intRow)
...
#Region "Convert To Employee"
    Private Function EmployeeCreation(ByVal aForm As SAPbouiCOM.Form, ByVal strcode As String) As Boolean
        Try
            ...
            strqry = strqry & " U_Z_PState,U_Z_PStreet,U_Z_PZipCode,U_Z_Passexpdate,U_Z_Passport,U_Z_Sex,U_Z_TBlock,U_Z_TBuilding,U_Z_TCity,U_Z_CurSalary,U_Z_SalFrom,U_Z_SalTo,"
            strqry = strqry & " U_Z_TCountry,U_Z_TState,U_Z_TStreet,U_Z_TZipCode,U_Z_SalFromDE,U_Z_SalToDE,U_Z_RefNo  from [@Z_HR_OCRAPP] where DocEntry='" & strcode & "'"
            otemp1.DoQuery(strqry)
            If otemp1.RecordCount > 0 Then
                ...
                Else
                    ...
                    strAllRef = otemp1.Fields.Item("U_Z_RefNo").Value
                    ...
                    oEmployee.UserFields.Fields.Item("U_Z_CurSalary").Value = otemp1.Fields.Item("U_Z_CurSalary").Value
                    oEmployee.UserFields.Fields.Item("U_Z_SalFrom").Value = otemp1.Fields.Item("U_Z_SalFrom").Value
                    oEmployee.UserFields.Fields.Item("U_Z_SalTo").Value = otemp1.Fields.Item("U_Z_SalTo").Value

                    oEmployee.UserFields.Fields.Item("U_Z_SalFromDE").Value = otemp1.Fields.Item("U_Z_SalFromDE").Value
                    oEmployee.UserFields.Fields.Item("U_Z_SalToDE").Value = otemp1.Fields.Item("U_Z_SalToDE").Value
                    ...
                    Else
                        ...
                        AddtoPayrollAllowance(strdocnum, strAllRef)
...
#End Region
    ...
    Private Function AddtoPayrollAllowance(ByVal empID As String, ByVal aRefCode As String) As Boolean
        ...
        Try
            ...
            If oTempRS.RecordCount > 0 Then
                oValidateRS.DoQuery("select * from [@Z_HR_EALL1]  where U_Z_RefNo='" & aRefCode & "'")
                For intRow As Integer = 0 To oValidateRS.RecordCount - 1
                    strQuery1 = "Select * from [@Z_PAY1] where U_Z_EARN_TYPE='" & oValidateRS.Fields.Item("U_Z_AllCode").Value & "' and U_Z_EMPID='" & empID & "'"
                    ...
                    If oTempRS.RecordCount <= 0 Then
                        ...
                        oUserTable.UserFields.Fields.Item("U_Z_Percentage").Value = 0
    ...
    Private Sub EnableDisable(ByVal aForm As SAPbouiCOM.Form, ByVal strStatus As String)
        If strStatus = "H" Then
            ...
            aForm.Items.Item("131").Enabled = False
            aForm.Items.Item("133").Enabled = False
            aForm.Items.Item("135").Enabled = False
        Else
            ...
            aForm.Items.Item("131").Enabled = True
            aForm.Items.Item("133").Enabled = True
            aForm.Items.Item("135").Enabled = True
        End If
    End Sub
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "1" And (oForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Or oForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE) Then
                                    ...
                                    End If
                                End If
                                If pVal.ItemUID = "136" Then
                                    Dim strcode As String = oApplication.Utilities.getEdittextvalue(oForm, "131")
                                    oApplication.Utilities.OpenMasterinLink(oForm, "Salary", strcode)
                                    BubbleEvent = False
                                    Exit Sub
                                ElseIf pVal.ItemUID = "137" Then
                                    Dim strcode As String = oApplication.Utilities.getEdittextvalue(oForm, "133")
                                    oApplication.Utilities.OpenMasterinLink(oForm, "Salary", strcode)
                                    BubbleEvent = False
                                    Exit Sub
                                ElseIf pVal.ItemUID = "138" Then
                                    Dim strcode As String = oApplication.Utilities.getEdittextvalue(oForm, "135")
                                    oApplication.Utilities.OpenMasterinLink(oForm, "Salary", strcode)
                                    BubbleEvent = False
                                    Exit Sub
                                End If
                                ...
                                Select Case pVal.ItemUID
                                    ...
                                    Case "71"
                                        ...
                                        If oApplication.SBO_Application.MessageBox("Do you want to Convert the Applicant to Employee ?", , "Yes", "No") = 2 Then
                                            Exit Sub
                                        End If
                                        If Validation(oForm, "Confirm") = True Then
                                ...
                                Try
                                    ...
                                    If (oCFLEvento.BeforeAction = False) Then
                                        ...
                                        If pVal.ItemUID = "90" Then
                                            ...
                                            End If
                                        End If
                                        If pVal.ItemUID = "131" Then
                                            val = oDataTable.GetValue("U_Z_SalCode", 0)
                                            Try
                                                oApplication.Utilities.setEdittextvalue(oForm, "131", val)
                                            Catch ex As Exception
                                                oForm.Freeze(False)
                                            End Try
                                            If oForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                                            ...
                                            End If
                                        End If
                                        If pVal.ItemUID = "133" Then
                                            val = oDataTable.GetValue("U_Z_SalCode", 0)
                                            val1 = oDataTable.GetValue("DocEntry", 0)
                                            Try
                                                oApplication.Utilities.setEdittextvalue(oForm, "139", val1)
                                                oApplication.Utilities.setEdittextvalue(oForm, "133", val)
                                            Catch ex As Exception
                                                oForm.Freeze(False)
                                            End Try
                                            If oForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                                            ...
                                            End If
                                        End If
                                        If pVal.ItemUID = "135" Then
                                            val = oDataTable.GetValue("U_Z_SalCode", 0)
                                            val1 = oDataTable.GetValue("DocEntry", 0)
                                            Try
                                                oApplication.Utilities.setEdittextvalue(oForm, "140", val1)
                                                oApplication.Utilities.setEdittextvalue(oForm, "135", val)
                                            Catch ex As Exception
                                                oForm.Freeze(False)
                                            End Try
                                            If oForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
