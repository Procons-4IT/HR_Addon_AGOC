            ...
            For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
                ...
                If oCheckbox.IsChecked(intRow) Then
                    ...
                    If oRec.RecordCount > 0 Then
                        ...
                        strqry = "SELECT T1.[U_Z_CompCode], T1.[U_Z_CompDesc], T1.[U_Z_Weight],isnull(T1.[U_Z_CompLevel],'0') as  [U_Z_CompLevel] FROM [dbo].[@Z_HR_OPOSCO]  T0  inner Join  [dbo].[@Z_HR_POSCO1]  T1 on T1.DocEntry=T0.DocEntry and T0.U_Z_PosCode='" & intJobCode & "'"
                        strqry += " Union All Select [U_Z_CompCode], [U_Z_CompName],[U_Z_Weight],isnull([U_Z_CompLevel],'0') as  [U_Z_CompLevel]  from [@Z_HR_ECOLVL] where U_Z_HREmpID=" & CInt(strempid)
