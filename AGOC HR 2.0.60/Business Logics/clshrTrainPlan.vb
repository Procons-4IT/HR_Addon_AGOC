...
Public Class clshrTrainPlan
    ...
    Private Sub databind(ByVal aForm As SAPbouiCOM.Form)
        ...
        oEditText = aForm.Items.Item("74").Specific
                                ...
                                Try
                                    ...
                                    If (oCFLEvento.BeforeAction = False) Then
                                        ...
                                        If pVal.ItemUID = "74" Then
                                            ...
                                            Try
                                                oApplication.Utilities.setEdittextvalue(oForm, "75", val)
                                                oApplication.Utilities.setEdittextvalue(oForm, "74", val1)
                                            Catch ex As Exception
                                                If oForm.Mode <> SAPbouiCOM.BoFormMode.fm_ADD_MODE And oForm.Mode <> SAPbouiCOM.BoFormMode.fm_UPDATE_MODE Then
                                                    oForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE
                                                End If
