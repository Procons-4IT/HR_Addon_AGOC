...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OCRY" Or strTab = "JDT1" Or strTab = "OUBR" Or strTab = "OADM" Or strTab = "OUDP" Or strTab = "OUBR" Or strTab = "OITT" Or strTab = "OHPS" Or strTab = "OITM" Or strTab = "INV1" Or strTab = "RDR1" Or strTab = "OINV" Or strTab = "OHEM" Or strTab = "OCLG") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            'AGOC Fields Start
            AddFields("Z_HR_OTRIN", "Z_LocCode", "Location Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_OTRIN", "Z_LocName", "Location Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)

            AddFields("Z_HR_ORMPREQ", "Z_ScYear", "Scheme(Year)", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            addField("@Z_HR_OPOSIN", "Z_IsVacant", "Is Vacant", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "Y")
            AddFields("Z_HR_OPOSIN", "Z_GrdFrom", "Grade From", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_OPOSIN", "Z_GrdTo", "Grade To", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)

            AddFields("Z_HR_OCRAPP", "Z_CVID", "CV_ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_HR_OCRAPP", "Z_OffPhNo", "Office Phone Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_HR_OCRAPP", "Z_HomePhNo", "Home Phone Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_HR_OCRAPP", "Z_GreAge", "Age (Gregorian)", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_HR_OCRAPP", "Z_HirijiAge", "Age (Hiriji)", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_HR_OCRAPP", "Z_Age", "Age", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_HR_OCRAPP", "Z_NationalID", "National ID", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_HR_OCRAPP", "Z_LatActDt", "Last Activity Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_HR_OCRAPP", "Z_CurSalary", "Current Salary Scale", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_OCRAPP", "Z_SalFrom", "Salary Scale From", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_OCRAPP", "Z_SalTo", "Salary Scale To", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_OCRAPP", "Z_SalFromDE", "Salary Scale From DocEntry", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_HR_OCRAPP", "Z_SalToDE", "Salary Scale To DocEntry", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_HR_OCRAPP", "Z_Language", "Languages", SAPbobsCOM.BoFieldTypes.db_Memo)
            AddFields("Z_HR_OCRAPP", "Z_TotalSalary", "Total Salary", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_HR_OCRAPP", "Z_Benifit", "Total Benifit", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_HR_OCRAPP", "Z_RefNo", "Reference Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)

            AddFields("Z_HR_CRAPP3", "Z_Education", "Education", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_HR_CRAPP3", "Z_CompDate", "Completion Date", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)

            AddFields("OHEM", "Z_CurSalary", "Current Salary Scale", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("OHEM", "Z_SalFrom", "Salary Scale From", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("OHEM", "Z_SalTo", "Salary Scale To", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("OHEM", "Z_SalFromDE", "Salary Scale From DocEntry", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("OHEM", "Z_SalToDE", "Salary Scale To DocEntry", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("OHEM", "Z_HirijiDob", "Hijri Date of birth", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("OHEM", "Z_RetDate", "Retirement Hijri Date", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)

            AddFields("Z_HR_OHEM3", "Z_TotalSalary", "Total Salary", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_HR_OHEM3", "Z_RefNo", "Reference Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)

            AddTables("Z_HR_OEALL", "Employee Allowance in Offer", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("Z_HR_OEALL", "Z_AppID", "Applicant ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_OEALL", "Z_AppName", "Applicant Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 150)
            AddFields("Z_HR_OEALL", "Z_Basic", "Basic Salary", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_HR_OEALL", "Z_RefNo", "Reference Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            AddFields("Z_HR_OEALL", "Z_LineNo", "Line Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)

            AddTables("Z_HR_EALL1", "Employee Allowance in Offer", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("Z_HR_EALL1", "Z_AllCode", "Allowance Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_EALL1", "Z_AllName", "Allowance Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 150)
            AddFields("Z_HR_EALL1", "Z_Amount", "Amount", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_HR_EALL1", "Z_RefNo", "Reference Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            AddFields("Z_HR_EALL1", "Z_LineNo", "Line Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            AddFields("Z_HR_OHEM1", "Z_InvRating", "Final Interview Rating", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)

            AddFields("Z_HR_EXPANCES", "Z_Amount", "Expenses Amount", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            addField("@Z_HR_EXPANCES", "Z_OverLap", "Expenses Overlap", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")

            AddFields("Z_HR_OSALST", "Z_LeaveCode", "Leave Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("Z_HR_OSALST", "Z_LeaveName", "Leave Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_HR_OSALST", "Z_Entitle", "Entitlement Days", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)

            AddFields("Z_HR_EXPCL", "Z_OverLap", "Expense Overlap", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            'AGOC Fields End
            ...
            AddFields("Z_PAY_LEAVE", "Z_Sort", "Sorting of Leave Types", SAPbobsCOM.BoFieldTypes.db_Numeric)
            ...
            AddFields("Z_HR_APHIS", "Z_NextApprover", "Next Approver", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            ...
            AddTables("Z_HR_LOANHIS", "Loan Approval History", SAPbobsCOM.BoUTBTableType.bott_Document)
            AddFields("Z_HR_LOANHIS", "Z_DocEntry", "Document Entry", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_HR_LOANHIS", "Z_DocType", "Document Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_HR_LOANHIS", "Z_EmpId", "Employee Id", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_HR_LOANHIS", "Z_EmpName", "Employee Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            addField("@Z_HR_LOANHIS", "Z_AppStatus", "Approved Status", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "P,A,R", "Pending,Approved,Rejected", "P")
            AddFields("Z_HR_LOANHIS", "Z_Remarks", "Comments", SAPbobsCOM.BoFieldTypes.db_Memo)
            AddFields("Z_HR_LOANHIS", "Z_ApproveBy", "Approved By", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_HR_LOANHIS", "Z_Approvedt", "Approver Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_HR_LOANHIS", "Z_ADocEntry", "Template DocEntry", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_HR_LOANHIS", "Z_ALineId", "Template LineId", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_HR_LOANHIS", "Z_LoanAmount", "Loan Amount", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_HR_LOANHIS", "Z_DisDate", "Distribution Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_HR_LOANHIS", "Z_StartDate", "Installment Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_HR_LOANHIS", "Z_NoEMI", "No.of Installment", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_HR_LOANHIS", "Z_LoanCode", "Loan Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_HR_LOANHIS", "Z_NextApprover", "Next Approver", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)


            AddFields("JDT1", "Z_ExpType", "Expense Claim Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("JDT1", "Z_BatchNo", "Employee Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)


            AddFields("JDT1", "Z_ClaimDate", "Expense Request Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("JDT1", "Z_AppDate", "Expense Approval Date", SAPbobsCOM.BoFieldTypes.db_Date)

            'AGOC Changes 2015-11-12
            'Hide Leave details in ESS
            addField("@Z_PAY_LEAVE", "Z_HideESS", "Hide in ESS", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")

            AddTables("Z_HR_LOGIN1", "Alternate Request Details", SAPbobsCOM.BoUTBTableType.bott_DocumentLines)
            AddFields("Z_HR_LOGIN1", "Z_DocType", "Document Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_HR_LOGIN1", "Z_DocDesc", "Document Description", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_HR_LOGIN1", "Z_EMPID", "Employee ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_LOGIN1", "Z_EMPNAME", "Employee Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            addField("@Z_HR_LOGIN", "Z_LoaneExp", "Loanee Expenses Request", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "Y")

            AddFields("Z_PAY_OLETRANS1", "Z_CrEmpID", "Created Employee ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY_OLETRANS1", "Z_CrEmpName", "Created Employee Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_HR_OTRAREQ", "Z_CrEmpID", "Created Employee ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_OTRAREQ", "Z_CrEmpName", "Created Employee Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_HR_EXPCL", "Z_CrEmpID", "Created Employee ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_EXPCL", "Z_CrEmpName", "Created Employee Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_HR_ONTREQ", "Z_CrEmpID", "Created Employee ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_ONTREQ", "Z_CrEmpName", "Created Employee Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_HR_TRIN1", "Z_CrEmpID", "Created Employee ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_TRIN1", "Z_CrEmpName", "Created Employee Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)



            'Replace Authorizer - 2015-12-14
            AddTables("Z_HR_RAUT", "Replace Authorizer Header", SAPbobsCOM.BoUTBTableType.bott_Document)
            AddFields("Z_HR_RAUT", "Z_CurAut", "Current Autorizer", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_RAUT", "Z_CurAutName", "Current Authorizer Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_HR_RAUT", "Z_RepAut", "Replace by", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_HR_RAUT", "Z_RepAutName", "Replaced Authorizer Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_HR_RAUT", "Z_Remarks", "Remarks", SAPbobsCOM.BoFieldTypes.db_Memo)
    ...
    Public Sub CreateUDO()
        Try
            ...
            AddUDO("Z_HR_OLOGIN", "LoginSetup", "Z_HR_LOGIN", "DocEntry", "U_Z_UID", "Z_HR_LOGIN1", , , , , , SAPbobsCOM.BoUDOObjType.boud_Document)

            AddUDO("Z_HR_LOANHIS", "Loan Approval History", "Z_HR_LOANHIS", "DocEntry", "U_Z_DocEntry", , , , , , , SAPbobsCOM.BoUDOObjType.boud_Document, True, "AZ_HR_LOANHIS")
            ...
            'Update UDO
            UpdateUDO_1("Z_HR_OLOGIN", "LoginSetup", "Z_HR_LOGIN", "DocEntry", "U_Z_UID", True, "Z_HR_LOGIN1", SAPbobsCOM.BoUDOObjType.boud_Document)
